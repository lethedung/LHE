...
public class CreateAccountantPageObject extends BasePage {

    public CreateAccountantPageObject() {
    }

    public CreateUserManagementPageObject clickCancelAccountantButton() {
        waitForElementClickable(AdminHomePageUI.CANCEL_ACCOUNTANT_BUTTON);
        clickToElement(AdminHomePageUI.CANCEL_ACCOUNTANT_BUTTON);
    ...
    public CreateAccountAccountantPageObject clickNextAccountantButton() {
        ...
        return new CreateAccountAccountantPageObject();
    }
