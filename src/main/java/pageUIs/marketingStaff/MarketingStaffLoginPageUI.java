...
public class MarketingStaffLoginPageUI {
	public static final String LOGIN_BUTTON = "//span[text()='Đăng nhập']";
	public static final String ICON_EYE = "//i[@class='v-icon eye-slash']";
	public static final String ACCOUNT_TEXTBOX = "//input[@placeholder='Nhập số điện thoại']";
	public static final String PASSWORD_TEXTBOX = "//input[@placeholder='Nhập mật khẩu']";
	public static final String ACCOUNT_EMPTY_ERROR_MESSAGE = "//input[@placeholder='Nhập số điện thoại']/parent::div[@class='input__content relative']/following-sibling::p";
