...
public class CreateMarketingStaffPageObject extends BasePage {
    ...
    public CreateMarketingStaffPageObject() {
    }

    public CreateUserManagementPageObject clickCancelMarketingStaffButton() {
        waitForElementClickable(AdminHomePageUI.CANCEL_MARKETING_STAFF_BUTTON);
        clickToElement(AdminHomePageUI.CANCEL_MARKETING_STAFF_BUTTON);
    ...
    public CreateAccountMarketingStaffPageObject clickNextMarketingStaffButton() {
        ...
        return new CreateAccountMarketingStaffPageObject();
    }
    ...
    public void clickToValueNationality() {
        scrollToElement(AdminHomePageUI.VALUE_NATIONALITY_IN_USER_MANAGEMENT_INPUT);
        sleepInSecond(SHORT_TIMEOUT);
        waitForElementClickable(AdminHomePageUI.VALUE_NATIONALITY_IN_USER_MANAGEMENT_INPUT);
        clickToElement(AdminHomePageUI.VALUE_NATIONALITY_IN_USER_MANAGEMENT_INPUT);
    }
    ...
    public void clickToValueNation() {
        scrollToElement(AdminHomePageUI.VALUE_NATION_IN_USER_MANAGEMENT_INPUT);
        sleepInSecond(SHORT_TIMEOUT);
        waitForElementClickable(AdminHomePageUI.VALUE_NATION_IN_USER_MANAGEMENT_INPUT);
        clickToElement(AdminHomePageUI.VALUE_NATION_IN_USER_MANAGEMENT_INPUT);
    }

    public void inputToRegion(String region) {
        scrollToElement(AdminHomePageUI.REGION_IN_USER_MANAGEMENT_INPUT);
        waitForElementClickable(AdminHomePageUI.REGION_IN_USER_MANAGEMENT_INPUT);
        sendKeyToElement(AdminHomePageUI.REGION_IN_USER_MANAGEMENT_INPUT, region);
    }

    public void clickToValueRegion() {
        scrollToElement(AdminHomePageUI.VALUE_REGION_IN_USER_MANAGEMENT_INPUT);
        sleepInSecond(SHORT_TIMEOUT);
        waitForElementClickable(AdminHomePageUI.VALUE_REGION_IN_USER_MANAGEMENT_INPUT);
        clickToElement(AdminHomePageUI.VALUE_REGION_IN_USER_MANAGEMENT_INPUT);
    }

    public void inputToArea(String area) {
        scrollToElement(AdminHomePageUI.AREA_IN_USER_MANAGEMENT_INPUT);
        waitForElementClickable(AdminHomePageUI.AREA_IN_USER_MANAGEMENT_INPUT);
        sendKeyToElement(AdminHomePageUI.AREA_IN_USER_MANAGEMENT_INPUT, area);
    }

    public void clickToValueArea() {
        scrollToElement(AdminHomePageUI.VALUE_AREA_IN_USER_MANAGEMENT_INPUT);
        sleepInSecond(THREE_SECONDS);
        waitForElementClickable(AdminHomePageUI.VALUE_AREA_IN_USER_MANAGEMENT_INPUT);
        clickToElement(AdminHomePageUI.VALUE_AREA_IN_USER_MANAGEMENT_INPUT);
    }
}
