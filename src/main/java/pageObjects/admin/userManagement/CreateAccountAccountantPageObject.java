...
public class CreateAccountAccountantPageObject extends BasePage {
    ...
    public CreateAccountAccountantPageObject() {
    }

    public boolean isAccountAccountantTextDisplayed() {
        waitForElementVisible(AdminHomePageUI.ACCOUNT_ACCOUNTANT_TEXT);
        return isElementDisplay(AdminHomePageUI.ACCOUNT_ACCOUNTANT_TEXT);
    }
